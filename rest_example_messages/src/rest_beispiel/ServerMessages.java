...
import demo.messages.MessageApplication;
...
public class ServerMessages {
	public static void main(String[] args) throws Exception {
		...
		ResourceConfig config = ResourceConfig.forApplicationClass(MessageApplication.class);
		...
		System.out.println("message server works.");
		System.in.read();
		server.shutdownNow();
	}
}
