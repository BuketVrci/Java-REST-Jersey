...
import demo.feedbacks.FeedbackApplication;
...
public class ServerFeedbacks {
	public static void main(String[] args) throws Exception {
		...
		ResourceConfig config = ResourceConfig.forApplicationClass(FeedbackApplication.class);
