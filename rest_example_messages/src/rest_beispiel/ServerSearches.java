...
import demo.searches.SearchApplication;
...
public class ServerSearches {
	public static void main(String[] args) throws Exception {
		...
		ResourceConfig config = ResourceConfig.forApplicationClass(SearchApplication.class);
		...
		System.out.println("enter the server search");
		System.in.read();
		server.shutdownNow();
	}
}
